...
<p>
	Session cookies are used within the scope of this Internet session for technical reasons.
	This data is deleted at the latest when you close your browser.
</p>

<h4>Links to Websites of Third Parties</h4>
<p>
	This website includes links to other external websites.
	These external links are designated with an icon as follows:
	${h.external_link('http://example.org', 'external link')}.
	References to the subordinate pages of this website are designated without an icon as follows:
	<a href="#">internal link example</a>.
</p>
